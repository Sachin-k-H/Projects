...
<nav class="navbar navbar-light " style="background-color: #000000;height:90px;">
	...
	<form class="row g-3 reg_form" action="createemployee" modelattribute="employee">

		<h1 Style="font-weight: 400;">Register Employee</h1>
		...
		<div class="col-md-4">
			...
			<select class="form-select " aria-label="Department Type" name="department"
				...
				<option selected value="${EmployeeDepartment}">${EmployeeDepartment}</option>
		...
		<input type="hidden" name="departmentId" value="${EmployeeDeptid}">
		<div class="col-md-12">
			<label for="inputArea" class="form-label">Name*</label> <input
				type="text" class="form-control" name="name" id="name"
				placeholder="Name" onblur="VerifyEmployeeName()" required>
				<p id="enteredname" style="color: red"></p>
		</div>
		<div class="col-md-12">
			<label for="inputArea" class="form-label">Designation*</label> <input
				type="text" class="form-control" name="designation" id="designation"
				placeholder="Designation" onblur="VerifyEmployeeDesignation()" required>
				<p id="entereddesignatin" style="color: red"></p>
		</div>
		<div class="col-md-12">
			<label for="inputArea" class="form-label">Email*</label> <input
				type="email" class="form-control" name="email" id="email"
				placeholder="email" onblur="VerifyEmployeeEmail()" required>
		...
		<div class="col-md-12">
			<label for="phone">Phone*</label> 
						...
						onblur="VerifyEmployeePhone()" required> 
		...
		<script src="/Issues_Management/res/EmployeeValidationNajax.js"></script>
	</form>
