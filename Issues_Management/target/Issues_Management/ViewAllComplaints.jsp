...
<h2 style="color: black; font-weight: 800">${message}</h2>
	<form class="d-flex" action="search" style="margin-top: 5px;">
		<input class="form-control mb-lg-2 me-2" name="type" type="search"
			placeholder="Search by Type" aria-label="Search">
		<input class="form-control mb-lg-2 me-2" name="city" type="search"
	...
	<table class="table  table-hover table-dark "  >
		<thead>
			<tr>
				...
				<th scope="col">Allocate Department</th>
				<th scope="col"></th>
		...
		<form action="changestatus" modelattribute="complaintsdto" method="post">
		<input name="id" value="${user.id}" hidden > </input>
			<tr>
				...
				<td scope="row"><div class="col-md" style="width: 120px;">
			<select class="form-select " aria-label="status" name="status"
				...
				<td scope="row"><div class="col-md" style="width: 100px;">
			<select class="form-select " aria-label="department" name="department"
				...
				<option value="5">5</option>
				 ...
				 <td scope="row"><a href="changestatus?complaintid=${user.id}&&department=${user.department}"><input type="submit" class="btn btn-primary" value="sumbit"></a></td> 
		</tr>
		</form>
		</c:forEach>
	</table>
