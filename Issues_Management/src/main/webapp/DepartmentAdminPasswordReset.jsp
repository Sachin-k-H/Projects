     ...
     <div class="container mt-5 col-md-4" style="font-weight: 400;">
             <div class="card style=width: 18rem;">
                 ...
                 <div class="card-body">
                      ...
                      <form action="setdeptadminpassword" method="post" id="signinForm">
                     <p style="color: green;">  ${msg}</p>
                       <span style="color:red">
                         ...
                         <div class="form-group mb-3">
                             ...
                             <input type="email" class="form-control" id="email" name="email"  ${action == 'retain' ? 'readonly' : ' '} value="${department.email}"  placeholder="Enter email">
