...
<body style="background-color: #f0f2f5;">
	...
	<nav class="navbar navbar-light "
		style="background-color: #000000; height: 80px;">
		<div class="container-fluid">
			<img src="https://avatars.githubusercontent.com/u/48981565?v=4"
			...
			<div class="dropdown">
				...
				<span style="color: white;">Hi, ${employee.name}</span> <img
				...
				<ul class="dropdown-menu">
					...
					<li><a class="dropdown-item"
						href="" style="color: Black;">Reset
							Password</a></li>
					<li><a class="dropdown-item"
						href="viewallassingedcomplaints"
						style="color: Black;">View All Assigned Complaints </a></li>
